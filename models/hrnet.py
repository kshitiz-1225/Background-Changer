...
class HighResolutionNet(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.stage1_cfg = {'NUM_MODULES': 1, 'NUM_BRANCHES': 1, 'BLOCK': Bottleneck, 'NUM_BLOCKS': [
            2], 'NUM_CHANNELS': [64], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage2_cfg = {'NUM_MODULES': 1, 'NUM_BRANCHES': 2, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            2, 2], 'NUM_CHANNELS': [18, 36], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage3_cfg = {'NUM_MODULES': 3, 'NUM_BRANCHES': 3, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            2, 2, 2], 'NUM_CHANNELS': [18, 36, 72], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage4_cfg = {'NUM_MODULES': 2, 'NUM_BRANCHES': 4, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            2, 2, 2, 2], 'NUM_CHANNELS': [18, 36, 72, 144], 'FUSE_METHOD': 'SUM'}
